+++
title = "传感器标定与测试：从误差分析到工程实践"
date = 2024-09-20T10:00:00+08:00
description = "传感器标定方法、误差分析与工程实践，让数据更可靠。"
...
> 📌 导读：传感器标定方法、误差分析与工程实践，让数据更可靠。

![示意图](/assets/diagrams/sensor-calibration.svg)
...
传感器数据是否可信，取决于标定和误差分析是否到位。把标定流程写进工程规范，是保证数据质量最有效的方式。
